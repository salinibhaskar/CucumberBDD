...
public class MenuStepDefinition extends CommonLibraries {
    ...
    @Then("I should be able to see appropriate {string}")
    public void i_should_be_able_to_see_appropriate(String expectedTitle) {
     String actualTitle = driver.getTitle();
        System.out.println("The title from UI :" + actualTitle);
